export const AccountService = {
  ...
  DELETE_ACCOUNT: "delete-account-service",
  FIND_EMAIL_ACCOUNT: "find-email-account-service",
};

export const AccountDescription = {
  LIST_ACCOUNT_SUCCESS: "Account List success",
  ...
  DELETE_ACCOUNT_SUCCESS: "Account creation",
  DELETE_ACCOUNT_FAILED: "Account Delete fail",
